  ...
  <div data-custom-class="body">
        ...
        <strong>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="subtitle">
              Last updated <bdt className="question">July 30, 2022</bdt>
            </span>
          </span>
        </strong>
      </span>
      ...
      <span style={{ color: "rgb(127, 127, 127)" }}>
        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
          <span data-custom-class="body_text">
            ...
            <bdt className="question">Parallax Engine</bdt>
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              <bdt className="question">
                <a
                  href="https://parallax-engine.vercel.app"
                  target="_blank"
                  data-custom-class="link"
                >
                  https://parallax-engine.vercel.app
                </a>
              </bdt>
              <span style={{ fontSize: 15 }}>
                <span style={{ color: "rgb(89, 89, 89)" }}>
    ...
    <div>
        ...
        <span style={{ fontSize: 15 }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span data-custom-class="body_text">
              ...
              please contact us at <bdt className="question">__________</bdt>.
            </span>
          </span>
        </span>
      </div>
      ...
      <div style={{ lineHeight: "1.5" }}>
        ...
        <a
          data-custom-class="link"
          href="https://app.termly.io/notify/f580a6f4-ae08-4e46-9b5e-b9234449154f"
                                                  ...
                                                  >
                                                    ...
                                                    >
                                                      <span data-custom-class="body_text">
                                                        ...
                                                        with our legal
                                                        obligations, respond to
                                                        legal requests, and
                                                        exercise, establish, or
